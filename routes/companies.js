...
const filterCompaniesSchema = require("../schemas/companyFilter.json");
...
router.get("/", async function (req, res, next) {
  try {
    ...
    let companies;
    if (req.query.name || req.query.minEmployees || req.query.maxEmployees) companies = await Company.filterAll(req.query);
